...
export default function EditGamePage({ params }: EditGamePageProps) {
    ...
    try {
      ...
      if (data.success) {
        ...
        setGameData({
          ...
          isPopular: data.game.isPopular
        })
        setDenominations(data.game.denominations)
      }
    } catch (error) {
  ...
  const handleDenominationChange = (index: number, field: string, value: string | number) => {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">Game yang Anda cari tidak ada atau telah dihapus.</p>
          <button
            onClick={() => router.push('/admin/games')}
            className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-xl font-medium"
          >
    ...
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-2">Edit informasi game dan denominasi</p>
        </div>
